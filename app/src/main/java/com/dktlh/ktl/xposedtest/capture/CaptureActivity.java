...
//        });
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ...
            Log.d("Check", "二维码原始信息：" + resultString);
            ...
            switch (requestCode) {
                case 1:
                    ...
                    if (resultString == null) {
                        Toast.makeText(getApplicationContext(), "解析错误，请选择正确的条维码图片", Toast.LENGTH_LONG).show();
                    } else {
    ...
    private Result scanningImage1(String picturePath) {
        ...
        try {
            ...
            Toast.makeText(CaptureActivity.this, "解析错误，请选择正确的二维码图片", Toast.LENGTH_LONG).show();
            e.printStackTrace();
     ...
     * 检查URL的地址是否是指定的
     */
//    private boolean checkIsEidBusiness(String result) {
//
//        return result.contains(StringUtil.EID_SITE) && (result.contains("eIDPassport/qrCodeIdentity") == false);
//    }
